...
class Luncher(QtWidgets.QWidget):
    ...
    def gtfo(self):
        ...
        self.Ltime=self.settingsWidget.valveBoxL.value()
        self.Rtime=self.settingsWidget.valveBoxR.value()
        self.settingsWidget.jsettings['mcu_config']['training_phase'] = self.settingsWidget.trainingPhaseBox.value()
        self.settingsWidget.jsettings['mcu_config']['transition'] = self.settingsWidget.transitionBox.value()
